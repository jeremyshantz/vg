...
${OBJECTDIR}/src/HElement.o: src/HElement.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HElement.o src/HElement.cpp
...
${OBJECTDIR}/src/PlacedGraphicIterator.o: src/PlacedGraphicIterator.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/PlacedGraphicIterator.o src/PlacedGraphicIterator.cpp
