...
${OBJECTDIR}/DriverTests.o: DriverTests.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/DriverTests.o DriverTests.cpp

${OBJECTDIR}/ElementListTests.o: ElementListTests.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ElementListTests.o ElementListTests.cpp

${OBJECTDIR}/ElementTests.o: ElementTests.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ElementTests.o ElementTests.cpp

${OBJECTDIR}/LayerTests.o: LayerTests.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/LayerTests.o LayerTests.cpp

${OBJECTDIR}/ParseTest.o: ParseTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ParseTest.o ParseTest.cpp

${OBJECTDIR}/PlacedGraphicTest.o: PlacedGraphicTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlacedGraphicTest.o PlacedGraphicTest.cpp

${OBJECTDIR}/PointTest.o: PointTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PointTest.o PointTest.cpp

${OBJECTDIR}/SceneReaderTest.o: SceneReaderTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SceneReaderTest.o SceneReaderTest.cpp

${OBJECTDIR}/SceneTest.o: SceneTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SceneTest.o SceneTest.cpp

${OBJECTDIR}/SceneWriterTest.o: SceneWriterTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SceneWriterTest.o SceneWriterTest.cpp

${OBJECTDIR}/VectorGraphicTest.o: VectorGraphicTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/VectorGraphicTest.o VectorGraphicTest.cpp

${OBJECTDIR}/XmlReaderTest.o: XmlReaderTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XmlReaderTest.o XmlReaderTest.cpp

${OBJECTDIR}/XmlWriterTest.o: XmlWriterTest.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/XmlWriterTest.o XmlWriterTest.cpp
...
${OBJECTDIR}/src/HVectorGraphic.o: src/HVectorGraphic.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/HVectorGraphic.o src/HVectorGraphic.cpp

${OBJECTDIR}/src/Layer.o: src/Layer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/Layer.o src/Layer.cpp
...
${OBJECTDIR}/src/VectorGraphic.o: src/VectorGraphic.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/VectorGraphic.o src/VectorGraphic.cpp

${OBJECTDIR}/src/VectorGraphicStreamer.o: src/VectorGraphicStreamer.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/VectorGraphicStreamer.o src/VectorGraphicStreamer.cpp

${OBJECTDIR}/src/VectorReader.o: src/VectorReader.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/VectorReader.o src/VectorReader.cpp
