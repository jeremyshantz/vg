...
TEST(loadXml, XmlReader)
{
    ...
    std::unique_ptr<Xml::HElement> root = Xml::Reader::loadXml(xmlStream);
   ...
   std::unique_ptr<Xml::HElement>  layer0 = children[0];
   ...
   std::unique_ptr< Xml::HElement> placedGraphic = layerChildren[0];
