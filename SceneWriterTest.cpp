...
TEST(WriteScene, SceneWriter)
{
   ...
   std::unique_ptr< Xml::HElement> readRoot = Xml::Reader::loadXml(xmlStream);
   ...
   std::unique_ptr<Xml::HElement> root = Framework::SceneWriter::writeScene(scene);
    ...
    std::unique_ptr<Xml::HElement> child = childElements[0];
